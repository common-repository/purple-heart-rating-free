jQuery( document ).ready( function () {
	...
	function add_keyup_event( e ) {
		e.on( 'keyup', function () {
			...
			/* get the id */
			if ( parent_el.hasClass( 'popover-title' ) ) {
				var input_id = '#wpbph_more_button_headline';
			} else if ( parent_el.hasClass( 'popover-content' ) ) {
				var input_id = '#wpbph_more_button_description';
			} else {
				var input_id = parent_el.data( 'forid' );
			}
